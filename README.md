...
Программный комплект не включает управленческую записку и презентацию. Примеры — рассчитанные решения при явно указанных допущениях, а не рекомендация организатора. Исходные условия и сценарии сохранены.
